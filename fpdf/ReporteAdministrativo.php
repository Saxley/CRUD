...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100);
      $this->SetFont('Times', 'B', 15);
      $this->Cell(100, 10, utf8_decode("REPORTE DE REGISTROS DE ENTIDAD ADMINISTRATIVO "), 0, 1, 'C', 0);
      $this->Ln(20);
...
while ($datos_reporte = $sql_reporte_entidades->fetch_object()) {      
   ...
   $pdf->Cell(35, 10, utf8_decode($datos_reporte->detalleatencion), 1, 1, 'C', 0); 
}

$pdf->Output('Reporte de Administrativo.pdf', 'I');
